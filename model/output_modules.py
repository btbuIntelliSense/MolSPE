...
from model.utils import act_class_mapping, GatedEquivariantBlock
    ...
    def __init__(self, hidden_channels, activation="silu", allow_prior_model=True):
        ...
        self.output_network = nn.ModuleList(
            [
                ...
                GatedEquivariantBlock(hidden_channels // 2,hidden_channels//4, activation=activation),
            ]
        )
...
class EquivariantScalar1(OutputModel):
    def __init__(self, hidden_channels, activation="silu", allow_prior_model=True):
        super(EquivariantScalar1, self).__init__(allow_prior_model=allow_prior_model)
        self.output_network = nn.ModuleList(
            [
                GatedEquivariantBlock(
                    hidden_channels,
...
class EquivariantVectorOutput(EquivariantScalar1):
    def __init__(self, hidden_channels, activation="silu"):
