...
def coords2unimol(
    atoms,mask_atom,coordinates,mask_coord,pos,pos_noise, targets,bond_adj,dictionary, max_atoms=256, **params
):
    ...
    return z,mask_z,coord,mask_coord,dist,mask_dist,targets,src_edge_type,pos,pos_noise,bond_adj
    # return {
    #     'z': z,
    #     'mask_z': mask_z,
    #     'coord': coord,
